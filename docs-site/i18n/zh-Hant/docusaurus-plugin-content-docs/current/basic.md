...
例如，如果您使用指令時計劃的自動退出時間是從現在起30分鐘，使用 `!more min=30` 將使計劃的自動退出時間再延長30分鐘，使其從現在起為60分鐘。
...
:::warning
這並不意味著"從現在起~分鐘後自動退出"，而是"將計劃的自動退出時間延長~分鐘"。
:::
