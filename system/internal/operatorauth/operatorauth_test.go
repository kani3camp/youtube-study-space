...
func TestResolveTarget(t *testing.T) {
	tests := []struct {
		...
		{name: "development", environment: "development", projectID: "test-youtube-study-space", wantProfile: "soraride-dev"},
		{name: "production", environment: "production", projectID: "youtube-study-space", wantProfile: "soraride-prod"},
	}
