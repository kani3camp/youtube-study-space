...
go build -o main    set_max_seats.go
C:\Users\momom\go\bin\build-lambda-zip.exe -output main.zip main
aws lambda create-function --function-name     set_max_seats     --runtime go1.x --zip-file fileb://main.zip --handler main --role arn:aws:iam::652333062396:role/service-role/my-first-golang-lambda-function-role-cb8uw4th --timeout 20
aws lambda update-function-code --function-name     set_max_seats     --zip-file fileb://main.zip
