...
var showUserInfoTestCases = []struct {
...
}{
	{
		...
		userIsMember:         false,
		currentSeatDoc:       nil,
		expectedReplyMessage: "@テストユーザーさん ［本日の作業時間：0分⏱️] ［累計作業時間：0分📊]",
	},
	{
		name: "ユーザー情報表示（入室時）",
		commandDetails: utils.CommandDetails{
		...
		expectedReplyMessage: "@テストユーザーさん ［本日の作業時間：10分⏱️] ［累計作業時間：10分📊]",
	},
}
...
var changeTestCases = []struct {
...
}{
	{
		...
		expectedReplyMessage: "@テストユーザーさん、作業内容を更新しました（5番席）✍️入室時間を360分に変更しました。現在10分入室中。自動退室まで残り349分です ⏱️",
	},
	{
		...
		expectedReplyMessage: "@テストユーザーさん、作業内容を更新しました（VIP7番席）✍️入室時間を360分に変更しました。現在10分入室中。自動退室まで残り349分です ⏱️",
	},
}
...
var moreTestCases = []struct {
...
}{
	{
		...
		expectedReplyMessage: "@テストユーザーさん、自動退室までの時間を30分延長しました ⏱️現在10分入室中。自動退室まで残り119分です ⏱️",
	},
	{
		name: "作業時間延長（メンバー席）",
		constantsConfig: myfirestore.ConstantsConfigDoc{
