...
const ( // TODO: ~~CollectionName, DocProperty~~に変更
	...
	LiveChatInbox             = "live-chat-inbox"
	LiveChatStreamState       = "live-chat-stream-state"
	LiveChatReplyOutbox       = "live-chat-reply-outbox"
	...
	AuthorChannelIDDocProperty       = "author-channel-id"
	SourceAuthorChannelIDDocProperty = "source-author-channel-id"
