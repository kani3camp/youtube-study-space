...
type ConstantsConfigDoc struct {
	...
	DesiredMaxSeats int `firestore:"desired-max-seats" json:"desired_max_seats"`
	CheckDesiredMaxSeatsIntervalMin int `firestore:"check-desired-max-seats-interval-min"`
