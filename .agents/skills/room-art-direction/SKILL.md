...
| ID | Reference | 要約 |
| --- | --- | --- |
| Direction A | `references/direction-a-clean-vivid-digital.md` | クリーンで鮮やか。ゲーム背景・アニメ背景・スタイライズド3Dの境界を行き来する高品質デジタル環境アート |

ユーザーが Direction A、この方向性、クリーンで鮮やかなゲーム背景系などを指定した場合は、対応する reference を読む。
